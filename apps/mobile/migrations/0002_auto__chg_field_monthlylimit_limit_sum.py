...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MonthlyLimit.limit_sum'
        db.alter_column(u'mobile_monthlylimit', 'limit_sum', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MonthlyLimit.limit_sum'
        raise RuntimeError("Cannot reverse this migration. 'MonthlyLimit.limit_sum' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'MonthlyLimit.limit_sum'
        db.alter_column(u'mobile_monthlylimit', 'limit_sum', self.gf('django.db.models.fields.FloatField')())
